...
def upload_image():
    ...
    files = { "image": ("face.jpeg", open("face.jpeg", "rb"), "image/jpeg") }
...
def post_requests():
    ...
    #     #In a case of empty value, the webhook will not be triggered"
        ...
        "source_url": "s3://d-id-images-prod/google-oauth2|104050255703233554578/img_iFOwA-KD8w8eEMARYaJQP/face.jpeg"
