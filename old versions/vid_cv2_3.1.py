...
# there is also adjustment to the full screen videos as it is not in the size of the screen initially.

# IMPORTANT!!- this code needs to be running at least once to calibrate, first time the sizes are messed up!
...
screen_width = int(cap2.get(3))
screen_height = int(cap2.get(4))
...
cv2.moveWindow('underwater', 200, 300)
