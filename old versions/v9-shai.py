# In this code we are testing the triggering of videos according to the openframeworks code. process of creating the videos is commented out.
# it seems like theres an issue with videos stopping before they finish and thats maybe because they are in different lengths.
# this might be solved when all matching lengths are stored in the matching cells of the vids arrays.
...
def play_vids(d_id_vid):
    ...
    cv2.moveWindow('underwater', 2000, 0)
